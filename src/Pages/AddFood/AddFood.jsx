  ...
  return (
    <section className="py-5 flex justify-center items-start bg-themed-secondary min-h-screen">
      ...
      <div className="w-full max-w-2xl bg-themed-card rounded-2xl shadow-lg p-8">
        ...
        {/* Donator Info */}
        <div className="mb-6 p-4 bg-themed-tertiary rounded-lg flex items-center gap-4">
          {user?.photoURL && (
            <img
              src={user.photoURL}
          ...
          <div>
            <p 
              ...
              style={{ color: isDarkMode ? '#ffffff' : '#14532d' }}
            >
              {user?.displayName || "Anonymous Donor"}
            </p>
            <p 
              className="text-xs" 
              style={{ color: isDarkMode ? '#ffffff' : '#166534' }}
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-themed-primary font-semibold mb-1 text-sm">
                Food Name *
              </label>
              <input
                type="text"
                ...
                className="input-themed w-full border rounded-lg px-3 py-2.5 text-sm focus:outline-green-500 focus:border-green-500"
